...
import { create } from '../redux/features/tourSlice';
...
const AddEditTour = () => {
  ...
  const handleSubmit =(e) =>{
    ...
    if(title && description && tags){
      ...
      dispatch(create({updateTourData, navigate, toast}))
      handleClear()
    }
  }
  ...
  return (
    <div style={{margin: "auto", padding: "15px", maxWidth: "480px", alignContent: "center", marginTop: "120px"}} className="container">
